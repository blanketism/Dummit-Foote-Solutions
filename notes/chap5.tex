...
If $p \mid q - 1$, put $P = \gen a$. Cyclicity of $\aut(Q)$ implies a unique subgroup of order $p$, say $\gen\alpha$. Then any $\phi : P \to \aut(Q)$ maps $a$ to powers of $\alpha$, or $\phi_i : a \mapsto \alpha^i$ for $0 \leq i \leq p - 1$. Note that $Q \semidir_{\phi_0} P \cong Q \times P$ since $\phi_0$ is trivial. 