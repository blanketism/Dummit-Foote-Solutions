...
\begin{exercise}[5.1.17]
    ...
    \begin{subexercises}
        ...
        \item Let $I = \z^+$ and let $p_i$ be the $i$th integer prime.
	    Show that if $G_i = \z/p_i\z$ for all $i \in \z^+$, then every element of the restricted direct product of the $G_i$'s has finite order but $\prod_{i \in \z^+} G_i$ has elements of infinite order.
...
\begin{solenum}
	...
	Thus, $H \nsub G$.
    \item Let $G = \prod_{i \in \z^+} G_i$ where $G_i = \z/p_i\z$ for all $i$.
...
\begin{solenum}
    ...
    \item Consider the group $\intmod[2] \times \z$.
    ...
    \item Let $G = \z \times \z \times \cdots$.
