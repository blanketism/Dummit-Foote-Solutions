...
\begin{exercise}[5.1.17]
    ...
    \begin{subexercises}
        ...
        \item Let $I = \mathbb{Z}^+$ and let $p_i$ be the $i$th integer prime. Show that if $G_i = \mathbb{Z}/p_i\mathbb{Z}$ for all $i \in \mathbb{Z}^+$, then every element of the restricted direct product of the $G_i$'s has finite order but $\prod_{i \in \mathbb{Z}^+} G_i$ has elements of infinite order. Show that in this example the restricted direct product is the torsion subgroup of the direct product (cf. \exref{2.1.16}).
    \end{subexercises}
\end{exercise}
