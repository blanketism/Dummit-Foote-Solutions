...
\begin{sol}
	...
	Since we already identify $x^2$ with $-1$ in the quotient, then the case of $q^2 = 1$ and $2i \equiv 0 \bmod 4$ gives the same element, hence only 1 element of order 2.
