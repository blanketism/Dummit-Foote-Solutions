...
\begin{sol}
    Let $k_1 \in \zp$ such that $n \geq k_1p$. Then there are exactly $k_1$ factors of $p$, namely $p, 2p, \ldots, k_1p$. Let $k_2 \in \zp$ such that $n \geq k_2p^2$, so that $p^2, 2p^2, \ldots, k_2p^2$ contribute exactly $k_2$ factors of $p^2$, and hence $k_2$ factors of $p$. Note that there exists some $m$ such that $n \geq k_m p^m$, but $n < k_{m + 1} p^{m + 1}$. Then the largest power of $p$ which divides $n!$ is given by
    \[\sum_{i = 1}^m k_i = \sum_{i = 1}^{\infty} \floor*{\frac{n}{p^i}}. \qh\]
\end{sol}
...
\begin{sol}
    ...
    If $\phi$ was finite as $n$ tends to infinity, then there would exist some $M \in \zp$ such that $\phi(n) \leq M$ for infinitely many $n$. However, this contradicts the fact that for each fixed $N \in \zp$, there are only finitely many $n$ such that $\phi(n) = N$. Hence, $\phi$ must tend to infinity as $n$ tends to infinity.
\end{sol}
