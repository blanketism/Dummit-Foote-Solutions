...
\begin{solalph}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            \item For $G_1 = Z_{15} \semidir_{\phi_1} Z_4$, we have $tpt\inv = p\inv$ and $tqt\inv = q$. Since $q \in G_1$ is centralized, we have the factorization
            \[G_1 \cong \gen{p, t} \times \gen q \cong (Z_5 \semidir Z_4) \times Z_3.\]
...
\begin{exercise}\label{ex5.5.16}
    Show that there are exactly 4 distinct homomorphisms from $Z_2$ into $\aut(Z_8)$. Prove that the resulting semidirect products are the groups $Z_8 \times Z_2, D_{16}$, the quasidihedral group $QD_{16}$, and the modular group $M$.
\end{exercise}
