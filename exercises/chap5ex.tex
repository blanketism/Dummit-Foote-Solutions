...
\begin{exercise}\label{ex5.5.7}
    ...
    \begin{subproblems}
        ...
        \item Prove that there is a unique group of order 56 with a nonnormal Sylow 7-subgroup. [For existence use the fact that $|GL_3(\f_2)| = 168$; for uniqueness use Exercise 6.]
    \end{subproblems}
\end{exercise}

\begin{solalph}
    \item Note that $56 = 2^3 \cdot 7$. By the Fundamental Theorem of Finite Abelian Groups, the abelian groups of order 56 are of the form $Z_8 \times Z_7$, $Z_4 \times Z_2 \times Z_7$, and $Z_2 \times Z_2 \times Z_2 \times Z_7$.
