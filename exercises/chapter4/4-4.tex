...
\begin{exercise}[4.4.3]
	Prove that under any automorphism of $D_8$, $r$ has at most $2$ possible images and $s$ has at most $4$ possible images (where $r$ and $s$ are the usual generators). Deduce that $|\aut(D_8)| \le 8$.
\end{exercise}
...
\begin{solitem}
	...
	\]
	for $k = 0, 1, 2, 3, 4, 5$. Therefore, $\aut(G) = \set{\psi_1, \psi_5}$.
\end{solitem}
