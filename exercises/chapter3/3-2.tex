...
\begin{exercise}[3.2.21]
    Prove that $\mathbb{Q}$ has no proper subgroups of finite index. Deduce that $\mathbb{Q}/\mathbb{Z}$ has no proper subgroups of finite index. [Recall \exref{1.6.21} and \exref{3.1.15}.]
\end{exercise}
