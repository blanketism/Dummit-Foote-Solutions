...
\begin{specialexercise}[3.1.14]
    ...
    \begin{subexercises}
        ...
        \item Show that $\mathbb{Q}/\mathbb{Z}$ is the torsion subgroup of $\mathbb{R}/\mathbb{Z}$ (cf. \exref{2.1.6}).
...
\begin{exercise}[3.1.15]
    Prove that a quotient of a divisible abelian group by any proper subgroup is also divisible. Deduce that $\mathbb{Q}/\mathbb{Z}$ is divisible (cf. \exref{2.4.19}).
\end{exercise}
